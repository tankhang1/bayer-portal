...
export function SimpleDataTables() {
  ...
  return (
    <>
      ...
      <Card className="tw-border tw-border-blue-gray-100 tw-shadow-sm tw-mt-8 tw-scroll-mt-4">
        ...
        <CardBody className="tw-flex tw-items-center tw-gap-2 tw-px-4">
          <select
                ...
                <tr key={headerGroup.id}>
                  {headerGroup.headers.map((header) => (
                    <th
                      ...
                      className="tw-p-4 tw-uppercase !tw-text-blue-gray-500 tw-border-b tw-border-blue-gray-100"
                    >
                      <Typography
                        color="blue-gray"
                        className="tw-flex tw-items-center tw-justify-between !tw-font-bold tw-gap-2 tw-text-xs tw-leading-none tw-opacity-40"
                      >
                        {flexRender(
